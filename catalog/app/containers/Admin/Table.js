...
export const Toolbar = RT.composeComponent('Admin.Table.Toolbar',
  RC.setPropTypes({
    heading: PT.node,
    selected: PT.number,
    actions: PT.array,
...
export const Head = RT.composeComponent('Admin.Table.Head',
  RC.setPropTypes({
...
export const Wrapper = RT.composeComponent('Admin.Table.Wrapper',
  withStyles(() => ({
    root: {
      overflowX: 'auto',
    },
